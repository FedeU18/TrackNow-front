        ...
        <Card sx={{ width: "100%", maxWidth: 900 }} variant="outlined">
          <CardContent>
            ...
            <Stack direction={{ xs: "column", sm: "row" }} spacing={2} sx={{ mb: 3 }}>
              <Button variant="contained" color="primary">Lista de Pedidos</Button>
              <Button variant="outlined" color="primary">Entregas Pendientes</Button>
              <Button variant="outlined" color="primary">Historial</Button>
